...
export default function LegalEntitesForm({ name, setName, account, setAccount, mobile, setPhone, mail, setMail, address, setAddress, setSite, site, setEdrpou, edrpou }) {
